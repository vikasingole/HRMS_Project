...
public class AuditLogController {
    ...
    public ResponseEntity<List<AuditLog>> getAuditLog(@RequestParam UUID userId){
       return new ResponseEntity<List<AuditLog>>(service.getAuditLog(userId), HttpStatus.OK);
    }
